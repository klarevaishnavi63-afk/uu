...
if(isset($_POST["submit"]))
{
	...
	$s = $_POST["subject"];
	$m = $_POST["message"];
	$sql = "INSERT INTO `contact` (`name`, `email`, `subject`, `message`) VALUES ('$n', '$e', '$s', '$m')";
...
<html>
<head>
<title>Fashion plus A Fashion Category Flat Bootstarp Resposive Website Template | Contact :: w3layouts</title>
